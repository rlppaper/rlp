...
class Game(c.Structure):
    _fields_ = [
        ...
        ('fetch_preset', CT_FUNC(c.c_bool, c.c_int, CT_PTR(
            c.c_char_p), CT_PTR(specific.GAMEPARAMS_PTR))),
        ('preset_menu', CT_FUNC(CT_PTR(PresetMenu))),
        ('decode_params', CT_FUNC(None, specific.GAMEPARAMS_PTR, c.c_char_p)),
        ...
        ('validate_params', CT_FUNC(c.c_char_p, specific.GAMEPARAMS_PTR, c.c_char_p)),
